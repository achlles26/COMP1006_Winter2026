  ...
  <form action="process.php" method="post">
    ...
    <fieldset>
      <legend>Customer Information</legend>
        ...
        <input type="text" id="first_name" name="first_name" minlength="2" maxlength="16" required>
        <label for="last_name">Last name</label>
        <input type="text" id="last_name" name="last_name" minlength="2" maxlength="16" required>
